...
@php
    ...
    $adminsCount = isset($Admins) ? count($Admins) : 0;
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header justify-content-center rounded bgi-no-repeat bgi-size-cover bgi-position-y-bottom bgi-position-x-center align-items-start h-250px" style="background-image:url('{{asset("admin/assets/media/patterns/pattern-1.jpg")}}')">
                            ...
                            <h3 class="card-title align-items-start flex-column text-white pt-15 mb-10 text-center ">
                                <span class="d-block fs-2x fw-bolder mb-3 w-100">Hello, {{auth('superadmin')->user()->name}}</span>
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5 ">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span class="symbol-label">
                                                    ...
                                                    <span class="fs-2qx fa fa-window-restore  text-primary">
                                                    </span>
                                                    <!--end::Svg Icon-->
                                                </span>
                                                </div>
                                                ...
                                                <div class="symbol   me-5 mb-8">
                                                    <span class="text-dark fw-boldest d-block fs-2qx lh-1 mb-1">{{$adminsCount}}</span>
                                                </div>
                                                <!--end::Symbol-->
                                            </div>
                                            <!--begin::Stats-->
                                            <div class=" mt-10">
                                                <!--begin::Number-->
                                                <span class="text-gray-700 fw-bold fs-2">No. Of Admins</span>
                                                <!--end::Number-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
